...
const frequencies = input.day1.split('\n');
...
console.group('Day 1');
console.log('Final frequency: ', getFrequency(frequencies)); // 538
...
console.log('First repeated frequency: ', getFirstRepeatedFrequency(frequencies)); // 77271
console.groupEnd('Day 1');
